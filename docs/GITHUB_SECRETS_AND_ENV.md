...
1. Open your repo: **[https://github.com/Mohamednajdawi/jo_service](https://github.com/Mohamednajdawi/jo_service)**
...
1. Go to **[https://railway.app](https://railway.app)** and open your project (e.g. `jo_service` / `joservice-production`)
